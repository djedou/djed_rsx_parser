...
use combine::combinator::{env_parser, look_ahead, optional, parser, token, tokens, r#try, sep_by1};
...
where
    I: Stream<Item = char>
{
    (r#try(parser(js_identifier_start)), optional(parser(js_identifier_part)))
